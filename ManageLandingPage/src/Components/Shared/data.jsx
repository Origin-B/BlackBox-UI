...
const features = [
  {
    ...
    children: {
      type: 'span',
      child: (
        <span className="bg-Orange-400 rounded-full p-[.5rem_1.5rem] text-white">
          01
        </span>
      ),
    },
...
const reviews = [
    ...
    children: {
      ...
      child: (
        <img
          ...
          alt="anisha image"
          className="w-15 xl:absolute xl:top-[-15%]"
        />
      ),
    },
    heading: 'Anisha Li',
  ...
  },
  {
    ...
    heading: 'Ali Bravo',
    body: '  “We have been able to cancel so many other subscriptions since usingManage. There is no more cross-channel confusion and everyone is muchmore focused.”',
  },
  {
    id: 3,
    children: {
  ...
  },
  {
    ...
    body: '“Their software allows us to track, manage and collaborate on our projects from anywhere. It keeps the whole team in-sync without being intrusive.”',
  },
];
...
export { navbarLisItems, features, reviews, footerListItems, footerIcons };
